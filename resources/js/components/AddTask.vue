    ...
    <div> <!--root-->
        ...
        <div v-show="showForm" class="form">
            <form @submit.prevent="addTask">
                ...
                <textarea v-model="newTitle" class="form__input form__input--nodrag" name="" rows="1"
                    placeholder="Tasks title" required></textarea>
                <br /><br />

                <textarea v-model="newDescription" class="form__input form__input--nodrag" name="" rows="2"
